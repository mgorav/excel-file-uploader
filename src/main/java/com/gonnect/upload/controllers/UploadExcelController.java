...
import com.gonnect.upload.utils.ExcelDataRow;
import com.gonnect.upload.utils.ExcelDataTable;
import com.gonnect.upload.utils.ExcelTableExcel;
import com.gonnect.upload.viewmodels.Product;
import com.gonnect.upload.viewmodels.UploadEvent;
      ...
      try {
         ...
         executor.submit(() -> {
            try {
               ...
               ExcelDataTable table = ExcelTableExcel.load(() -> inputStream);

               int rowCount = table.rowCount();

               for(int i=0; i < rowCount; ++i) {
                  ExcelDataRow row = table.row(i);
